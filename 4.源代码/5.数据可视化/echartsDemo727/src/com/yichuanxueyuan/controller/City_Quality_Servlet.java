...
public class City_Quality_Servlet extends HttpServlet {


	public City_Quality_Servlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		City_quality_Manager cqm =new  City_quality_Manager();
	  
		List lists = cqm.queryAllCity_quality();
